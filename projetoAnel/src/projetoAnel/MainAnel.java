...
/**
 * Classe que recebe as entradas do usuário e verifica se forma um anel.
 */
public class MainAnel {
	...
	/**
	 * Definir o conjunto a ser analisado.
	 * 
	 * @param quantElem quantidade de elementos no conjunto.
	 * @param sc Scanner para receber a entrada do usuário.
	 * @return O conjunto formado
	 */
	...
	/**
	 * Define a tabela de uma operação.
	 * 
	 * @param operacao Operação que terá a tabela definida.
	 * @param quantElem Quantidade de elementos do conjunto.
	 * @param sc Scanner para receber a entrada do usuário.
	 * @return A tabela definida.
	 */
	...
	/**
	 * Ajusta a tabela para o formato de matriz de inteiros.
	 * 
	 * @param tabela Tabela a ser ajustada.
	 * @return Tabela ajustada
	 */
